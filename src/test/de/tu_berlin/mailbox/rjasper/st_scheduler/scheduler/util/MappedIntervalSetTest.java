...
public class MappedIntervalSetTest {
	...
	private static Interval<LocalDateTime> interval(LocalDateTime from, LocalDateTime to) {
	...
	public void testIterator() {
		IntervalSet<LocalDateTime> jobSet = mappedIntervalSet(
			atSecond(0), atSecond(2),
			atSecond(2), atSecond(4),
			atSecond(5), atSecond(6));

		Iterator<Interval<LocalDateTime>> it = jobSet.iterator();

		assertThat(it.next(), equalTo(interval(atSecond(0), atSecond(4))));
		assertThat(it.next(), equalTo(interval(atSecond(5), atSecond(6))));
	...
	public void testDescendingIterator() {
		...
		Iterator<Interval<LocalDateTime>> it = jobSet.descendingIterator();
