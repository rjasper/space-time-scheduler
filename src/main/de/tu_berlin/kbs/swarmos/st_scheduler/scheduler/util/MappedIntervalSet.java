...
extends AbstractIntervalSet<T>
{
	...
	@Override
	public de.tu_berlin.kbs.swarmos.st_scheduler.scheduler.util.IntervalSet.Interval<T> minInterval() {
		return interval( map.firstEntry() );
	}

	@Override
	public de.tu_berlin.kbs.swarmos.st_scheduler.scheduler.util.IntervalSet.Interval<T> maxInterval() {
