...
import de.tu_berlin.kbs.swarmos.st_scheduler.world.util.DoubleSubPointPathOperation;
import de.tu_berlin.kbs.swarmos.st_scheduler.world.util.Seeker;
import de.tu_berlin.kbs.swarmos.st_scheduler.world.util.TrajectoryComposer;
...
public class DecomposedTrajectory implements Trajectory {
	...
	/**
	 * @return
	 * @see de.tu_berlin.kbs.swarmos.st_scheduler.world.SimpleTrajectory#size()
	 */
	@Override
	public int size() {
