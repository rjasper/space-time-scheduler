...
public class AccessOperations {
	...
	public void assignPoint(String variableName, double[] data) throws MatlabInvocationException {
	...
	public void assignTrajectory(String variableName, double[] data) throws MatlabInvocationException {
		MatlabProxy m = getProxy();

		m.feval("assign_feval", variableName, "j2m_line_string", data, 3);
	}

	public double[] retrieveTrajectory(String variableName) throws MatlabInvocationException {
		MatlabProxy m = getProxy();
